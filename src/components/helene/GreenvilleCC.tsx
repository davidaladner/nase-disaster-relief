...
export default () => <CommandCenter
  ...
  campingInfo={
    ...
    <div>
      ...
      <p>Portable toilets and places for tents are available at the campsite, which is 2.5 miles from the command center.  Bring all your own needed supplies for the camping experience.  No one will be permitted inside the church.</p>
